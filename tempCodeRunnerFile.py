...
class Obstacle(pygame.sprite.Sprite):
    def __init__(self,type):
        ...
        self.rect = self.image.get_rect(midbottom = (random.randint(500, 600), yPos))
...
async def main():
    ...
    global player, obstacleGroup, startScreenRect
    x = 0
    y = 0
    test = False
    while True:
